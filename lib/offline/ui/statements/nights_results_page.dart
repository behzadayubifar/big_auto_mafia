...
import 'package:auto_mafia/offline/ui/statements/result_row_widget.dart';
import 'package:auto_mafia/offline/ui/statements/statement_overlay_screen.dart';
...
//
                                      if (winner != null) {
                                        ...
                                        final List<Player>
                                            allDeadAndAlivePlayers =
                                            alivePlayers.players + dead;

                                        context.go(
                                          '/game_over/$winner',
                                          extra: allDeadAndAlivePlayers,
                                        );
                                        return;
                                      } else {
