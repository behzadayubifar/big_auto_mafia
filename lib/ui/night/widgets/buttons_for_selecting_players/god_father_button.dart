...
part 'god_father_button.g.dart';

@riverpod
class GodfatherChoiseController extends _$GodfatherChoiseController {
  @override
  FutureOr<void> build(playerName) {}
}

class GodFatherChoiceButton extends ConsumerWidget {
  GodFatherChoiceButton({
  ...
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final choiceAsync = ref.watch(godfatherChoiseControllerProvider(''));
    return Container();
  }
}
